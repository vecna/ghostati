...
The tests exercise complementary-project generation and category filtering, cultural-reference page rendering and archive navigation, loader behavior, overlay mode behavior, and face-matching workflows against the static app served locally.
